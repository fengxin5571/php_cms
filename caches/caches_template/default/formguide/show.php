...
<div class="main">
	<div class="col-left">
    	<div class="crumbs"><a href="<?php echo siteurl($siteid);?>">首页</a><span> &gt; </span> <?php echo $name;?></div>
        <div id="Article">
        	<h1><?php echo $name;?></h1>
			<div class="content">
				<form method="post" action="?m=formguide&c=index&a=show&formid=<?php echo $formid;?>" name="myform" id="myform">
