...
'cookie_pre' => 'xWtFO_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
'js_path' => 'http://192.168.1.143/php_cms/statics/js/', //CDN JS
'css_path' => 'http://192.168.1.143/php_cms/statics/css/', //CDN CSS
'img_path' => 'http://192.168.1.143/php_cms/statics/images/', //CDN img
'app_path' => 'http://192.168.1.143/php_cms/',//动态域名配置地址
...
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => 'IrE9EWMQrlmDQv2LSIDt', //密钥
'lang' => 'zh-cn',  //网站语言包
...
'phpsso' => '1',	//是否使用phpsso
'phpsso_appid' => '1',	//应用id	
'phpsso_api_url' => 'http://localhost/php_cms/phpsso_server',	//接口地址
'phpsso_auth_key' => '9kREdkhgRoRogRuMt6Pgc6AagFEeUsB9', //加密密钥
