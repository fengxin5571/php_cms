...
<span class="edit_content">
<input type=\'button\' value="显示已有" onclick="show_relation({MODELID},{ID},1)" class="button" style="width:66px;">
</span>
</div>',
    'fieldtype' => 'varchar',
    'minnumber' => '1',
